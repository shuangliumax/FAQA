...
if __name__ == '__main__':
  ...
  for i in range(num_images):
      ...
      rois_label, _, _, _, _, _ = fasterRCNN(im_data, im_info, gt_boxes, num_boxes)
  ...
  print('Total inference time: {:.4f}s'.format(total_detect_time))
  print('Average inference time per image: {:.4f}s'.format(total_detect_time / num_images))
